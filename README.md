...
*DuckDuckGo Tracker Radar*: TrackerControl uses some (but not all) [information](https://github.com/duckduckgo/tracker-radar) that lie at the heart of DuckDuckGo's tracking analysis technologies.
