...
public class ActivityForwarding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(R.string.setting_forwarding);
        ...
        lvForwarding.setOnItemClickListener((parent, view, position, id) -> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_add) {
            ...
            dialog = new AlertDialog.Builder(this)
                    ...
                    .setOnDismissListener(dialogInterface -> dialog = null)
                    .create();
            dialog.show();
            return true;
        }
